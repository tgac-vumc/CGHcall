...
norm.cghdata <- normalize(cghdata, type="dataframe", method="median", cellularity=tumor.prop, smoothOutliers=TRUE)
@
...
seg.cghdata <- segmentData(norm.cghdata, type="dataframe", method="DNAcopy")
@
